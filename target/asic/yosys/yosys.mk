...
# Flags
SN_YOSYS_BENDER_DEFINES = -D VERILATOR=1 -D SYNTHESIS=1 -D COMMON_CELLS_ASSERTS_OFF=1
SN_YOSYS_BENDER_TARGETS = $(SN_COMMON_BENDER_ASIC_FLAGS) -t ihp13 -t synthesis
SN_YOSYS_BENDER_FLAGS   = $(SN_YOSYS_BENDER_DEFINES) $(SN_YOSYS_BENDER_TARGETS)
