...
#
# It ignores following tests as we cannot build them with the snitch
# compiler toolchain.
# - rv32ua: specified immediate (rv32ua/../rv64ua/amomaxu_w.S:34:55) exceeds integer range
# - rv32uf: The qNaN #define uses the '0f:' specifier which is not recognized by our LLVM.
# - rv32ud: same as rv32uf, but with '0d:'.
# - rv32mi: CSR tcontrol is not recognized
#
# It ignores the following test cases as we don't implement the extensions
# - rv32si
# - rv32uzfh
# - rv32uzba
# - rv32uzbb
