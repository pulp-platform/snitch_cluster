...
```
 ...
 1164000     1135        M 0x80000260 addi    a0, a0, -1396          #; a0  = 0x8000525c, (wrb) a0  <-- 0x80004ce8
 1166000     1137        M 0x80000268 add     a0, a6, a2             #; a6  = 0x10001800, a2  = 0, (wrb) a0  <-- 0x10001800
 1167000     1138        M 0x8000026c scfgwi  a0, 898                #; a0  = 0x10001800
                         M 0x80000264 fld     ft3, 0(a0)             #; ft3  <~~ Doub[0x80004ce8]
 1169000     1140        M 0x80000270 csrsi   ssr, 1                 #; 
 1170000     1141        M 0x80000274 frep    48, 1                  #; outer, 48 issues
 1177000     1148        M                                           #; (f:lsu) ft3  <-- -32.7504962
```
...
These performance metrics can also be dumped to a JSON file for further processing (see [gen_trace.py](../../util/trace/gen_trace.py)).
A detailed description of each of the performance metrics follows:
