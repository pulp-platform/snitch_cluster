...
```shell
$ sudo docker build -t ghcr.io/kuleuven-micas/snax:latest -f util/container/DockerfileChisel .
```
...
```shell
$ docker run -it -v $REPO_TOP:/repo -w /repo ghcr.io/kuleuven-micas/snax:latest
```
