...
module snitch_sequencer import snitch_pkg::*; #(
    ...
    output fpu_sequencer_trace_t             trace_o,
    // pragma translate_on
  ...
  always_comb begin : proc_decoder
    ...
    unique casez (inp_qdata_op_i)
      snitch_riscv_instr::FREP_O,
      snitch_riscv_instr::IREP: begin
        inst_path_sel = Frep;
      end
      ...
      snitch_riscv_instr::FEQ_S,
      snitch_riscv_instr::FCLASS_S,
      snitch_riscv_instr::FCVT_W_S,
      snitch_riscv_instr::FCVT_WU_S,
      // snitch_riscv_instr::FMV_X_W,
      snitch_riscv_instr::VFEQ_S,
      snitch_riscv_instr::VFEQ_R_S,
      snitch_riscv_instr::VFNE_S,
      snitch_riscv_instr::VFNE_R_S,
      snitch_riscv_instr::VFLT_S,
      snitch_riscv_instr::VFLT_R_S,
      snitch_riscv_instr::VFGE_S,
      snitch_riscv_instr::VFGE_R_S,
      snitch_riscv_instr::VFLE_S,
      snitch_riscv_instr::VFLE_R_S,
      snitch_riscv_instr::VFGT_S,
      snitch_riscv_instr::VFGT_R_S,
      snitch_riscv_instr::VFCLASS_S,
      snitch_riscv_instr::FLE_D,
      // snitch_riscv_instr::FLT_D,
      snitch_riscv_instr::FEQ_D,
      snitch_riscv_instr::FCLASS_D,
      // snitch_riscv_instr::FCVT_W_D,
      // snitch_riscv_instr::FCVT_WU_D,
      snitch_riscv_instr::FMV_X_D,
      snitch_riscv_instr::FLE_H,
      snitch_riscv_instr::FLT_H,
      snitch_riscv_instr::FEQ_H,
      snitch_riscv_instr::FCLASS_H,
      snitch_riscv_instr::FCVT_W_H,
      snitch_riscv_instr::FCVT_WU_H,
      snitch_riscv_instr::FMV_X_H,
      snitch_riscv_instr::VFEQ_H,
      snitch_riscv_instr::VFEQ_R_H,
      snitch_riscv_instr::VFNE_H,
      snitch_riscv_instr::VFNE_R_H,
      snitch_riscv_instr::VFLT_H,
      snitch_riscv_instr::VFLT_R_H,
      snitch_riscv_instr::VFGE_H,
      snitch_riscv_instr::VFGE_R_H,
      snitch_riscv_instr::VFLE_H,
      snitch_riscv_instr::VFLE_R_H,
      snitch_riscv_instr::VFGT_H,
      snitch_riscv_instr::VFGT_R_H,
      snitch_riscv_instr::VFCLASS_H,
      snitch_riscv_instr::VFMV_X_H,
      snitch_riscv_instr::VFCVT_X_H,
      snitch_riscv_instr::VFCVT_XU_H,
      snitch_riscv_instr::FLE_B,
      snitch_riscv_instr::FLT_B,
      snitch_riscv_instr::FEQ_B,
      snitch_riscv_instr::FCLASS_B,
      snitch_riscv_instr::FCVT_W_B,
      snitch_riscv_instr::FCVT_WU_B,
      snitch_riscv_instr::FMV_X_B,
      snitch_riscv_instr::VFEQ_B,
      snitch_riscv_instr::VFEQ_R_B,
      snitch_riscv_instr::VFNE_B,
      snitch_riscv_instr::VFNE_R_B,
      snitch_riscv_instr::VFLT_B,
      snitch_riscv_instr::VFLT_R_B,
      snitch_riscv_instr::VFGE_B,
      snitch_riscv_instr::VFGE_R_B,
      snitch_riscv_instr::VFLE_B,
      snitch_riscv_instr::VFLE_R_B,
      snitch_riscv_instr::VFGT_B,
      snitch_riscv_instr::VFGT_R_B,
      snitch_riscv_instr::VFCLASS_B,
      snitch_riscv_instr::VFMV_X_B,
      snitch_riscv_instr::VFCVT_X_B,
      snitch_riscv_instr::VFCVT_XU_B,

      // int to float
      // snitch_riscv_instr::FMV_W_X,
      snitch_riscv_instr::FCVT_S_W,
      snitch_riscv_instr::FCVT_S_WU,
      // snitch_riscv_instr::FCVT_D_W,
      // snitch_riscv_instr::FCVT_D_WU,
      snitch_riscv_instr::FMV_H_X,
      snitch_riscv_instr::FCVT_H_W,
      snitch_riscv_instr::FCVT_H_WU,
      snitch_riscv_instr::VFMV_H_X,
      snitch_riscv_instr::VFCVT_H_X,
      snitch_riscv_instr::VFCVT_H_XU,
      snitch_riscv_instr::FMV_B_X,
      snitch_riscv_instr::FCVT_B_W,
      snitch_riscv_instr::FCVT_B_WU,
      snitch_riscv_instr::VFMV_B_X,
      snitch_riscv_instr::VFCVT_B_X,
      snitch_riscv_instr::VFCVT_B_XU,
      snitch_riscv_instr::IMV_X_W,
      snitch_riscv_instr::IMV_W_X,

      // CSR accesses
      snitch_riscv_instr::CSRRW,
      snitch_riscv_instr::CSRRS,
      snitch_riscv_instr::CSRRC,
      snitch_riscv_instr::CSRRWI,
      snitch_riscv_instr::CSRRSI,
  ...
  // pragma translate_off
  assign trace_o.source    = snitch_pkg::SrcFpuSeq;
  assign trace_o.cbuf_push = core_frep_valid && core_frep_ready;
  assign trace_o.max_inst  = inp_qdata_op_i[20+:DepthBits] - 1;
  assign trace_o.max_iter  = inp_qdata_arga_i[LoopIterBits-1:0];
  assign trace_o.stg_max   = inp_qdata_op_i[14:12];
  assign trace_o.stg_mask  = inp_qdata_op_i[11:8];
  // pragma translate_on
