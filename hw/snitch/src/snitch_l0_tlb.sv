...
module snitch_l0_tlb import snitch_pkg::*; #(
  ...
  tag_t [cc_pkg::iomsb(NrEntries):0] tag_d, tag_q;
  logic [cc_pkg::iomsb(NrEntries):0] is_4mega_exp; //expanded version
  logic is_4mega;
  // Tag is valid array.
  logic [cc_pkg::iomsb(NrEntries):0] tag_valid_d, tag_valid_q;
  logic [$clog2(NrEntries+1)-1:0] evict_d, evict_q;

  l0_pte_t [cc_pkg::iomsb(NrEntries):0] pte_q, pte_d;
  ...
  logic [cc_pkg::iomsb(NrEntries):0] hit;
