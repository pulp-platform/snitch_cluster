...
inline void __istc_setup_issrs(uint32_t idxsize, uint32_t i0l, uint32_t i1l) {
    ...
    __rt_sssr_cfg_write(__RT_SSSR_IDX_CFG(idxsize, 0, 0), 0, __RT_SSSR_REG_IDX_CFG);
    __rt_sssr_cfg_write(__RT_SSSR_IDX_CFG(idxsize, 0, 0), 1, __RT_SSSR_REG_IDX_CFG);
...
inline void __istc_iter_issrs(void* base, void* i0, void* i1) {
    ...
    __rt_sssr_cfg_write_ptr(base, 0, __RT_SSSR_REG_IDX_BASE);
    __rt_sssr_cfg_write_ptr(base, 1, __RT_SSSR_REG_IDX_BASE);
