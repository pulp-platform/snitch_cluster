...
class Box3D1RDataGen(du.DataGen):
    ...
    def emit_header(self, **kwargs):
        ...
        header += [du.format_scalar_definition('const int', 'r', R)]
        header += [du.format_scalar_definition('const int', 'nx', NX)]
        header += [du.format_scalar_definition('const int', 'ny', NY)]
        header += [du.format_scalar_definition('const int', 'nz', NZ)]
