...
from datagen import MCBox3D1RDataGen

sys.path.append(str(Path(__file__).parent / '../../../../util/sim/'))
from verif_utils import Verifier  # noqa: E402


class MCBox3D1RVerifier(Verifier):
    ...
    def get_expected_results(self):
        ...
        return MCBox3D1RDataGen().golden_model(1, 16, 16, 16, C, A)
...
if __name__ == "__main__":
    sys.exit(MCBox3D1RVerifier().main())