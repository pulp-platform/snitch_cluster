...
import sys
from datagen import J3D27PTDataGen

from snitch.util.sim.verif_utils import Verifier


class J3D27PTVerifier(Verifier):
    ...
    def get_expected_results(self):
        FAC = self.get_input_from_symbol('fac', 'uint32_t')
        ...
        return J3D27PTDataGen().golden_model(FAC, NX, NY, NZ, C, A)
