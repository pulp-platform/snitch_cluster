...
int main() {
  ...
  if (snrt_is_dm_core()) {
    a = (float *)snrt_l1_alloc(gemm_l.M * gemm_l.K * sizeof(float));
    b = (float *)snrt_l1_alloc(gemm_l.K * gemm_l.N * sizeof(float));
    c = (float *)snrt_l1_alloc(gemm_l.M * gemm_l.N * sizeof(float));
