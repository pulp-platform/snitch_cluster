...
int main() {
    ...
    l1_a = (uint32_t *)snrt_l1_alloc(n_elem * sizeof(uint32_t));
    l1_b = (uint32_t *)snrt_l1_alloc(n_elem * sizeof(uint32_t));
    l1_c = (uint32_t *)snrt_l1_alloc(n_elem * sizeof(uint32_t));
    l1_d = (uint32_t *)snrt_l1_alloc(n_elem * sizeof(uint32_t));
    l1_2d_a = (uint32_t *)snrt_l1_alloc(n_elem * n_rep * sizeof(uint32_t));
    uint32_t *l3_a, *l3_2d_a;
    l3_a = (uint32_t *)snrt_l3_alloc(n_elem * sizeof(uint32_t));
    l3_2d_a = (uint32_t *)snrt_l3_alloc(n_elem * n_rep * sizeof(uint32_t));
