...
#;   1:  auipc   gp, %pcrel_hi(__global_pointer$)
            489000    0x800000f8 auipc gp, 5                    #; (wrb) gp  <-- 0x800050f8
#; snrt.crt0.init_fp_registers (start.S:79)
#;   fcvt.d.w f31, zero
                      0x800000f4 fcvt.d.w ft11, zero            #; ac1  = 0, (f:fpu) ft9  <-- 0.0
#; .Ltmp1 (start.S:89)
#;   addi    gp, gp, %pcrel_lo(1b)
            490000    0x800000fc addi gp, gp, 1520              #; gp  = 0x800050f8, (wrb) gp  <-- 0x800056e8
                                                                #; (f:fpu) ft10 <-- 0.0
...
#;   la        t0, __cdata_end
            506000    0x80000130 auipc t0, 5                    #; (wrb) t0  <-- 0x80005130
            507000    0x80000134 addi t0, t0, -600              #; t0  = 0x80005130, (wrb) t0  <-- 0x80004ed8
#; .Lpcrel_hi1 (start.S:122)
#;   la        t1, __cdata_start
            508000    0x80000138 auipc t1, 5                    #; (wrb) t1  <-- 0x80005138
            509000    0x8000013c addi t1, t1, -608              #; t1  = 0x80005138, (wrb) t1  <-- 0x80004ed8
#; .Lpcrel_hi1 (start.S:123)
#;   sub       t0, t0, t1
            510000    0x80000140 sub t0, t0, t1                 #; t0  = 0x80004ed8, t1  = 0x80004ed8, (wrb) t0  <-- 0
#; .Lpcrel_hi1 (start.S:124)
#;   sub       a2, a2, t0
            511000    0x80000144 sub a2, a2, t0                 #; a2  = 0x10020000, t0  = 0, (wrb) a2  <-- 0x10020000
#; .Lpcrel_hi2 (start.S:125)
#;   la        t0, __cbss_end
            512000    0x80000148 auipc t0, 5                    #; (wrb) t0  <-- 0x80005148
            513000    0x8000014c addi t0, t0, -592              #; t0  = 0x80005148, (wrb) t0  <-- 0x80004ef8
#; .Lpcrel_hi3 (start.S:126)
#;   la        t1, __cbss_start
            514000    0x80000150 auipc t1, 5                    #; (wrb) t1  <-- 0x80005150
            515000    0x80000154 addi t1, t1, -632              #; t1  = 0x80005150, (wrb) t1  <-- 0x80004ed8
#; .Lpcrel_hi3 (start.S:127)
#;   sub       t0, t0, t1
            516000    0x80000158 sub t0, t0, t1                 #; t0  = 0x80004ef8, t1  = 0x80004ed8, (wrb) t0  <-- 32
...
#;   la        t0, __tdata_end
            526000    0x80000180 auipc t0, 5                    #; (wrb) t0  <-- 0x80005180
            527000    0x80000184 addi t0, t0, -748              #; t0  = 0x80005180, (wrb) t0  <-- 0x80004e94
#; .Lpcrel_hi5 (start.S:156)
#;   la        t1, __tdata_start
            528000    0x80000188 auipc t1, 5                    #; (wrb) t1  <-- 0x80005188
            529000    0x8000018c addi t1, t1, -768              #; t1  = 0x80005188, (wrb) t1  <-- 0x80004e88
#; .Lpcrel_hi5 (start.S:157)
#;   sub       t0, t0, t1
            530000    0x80000190 sub t0, t0, t1                 #; t0  = 0x80004e94, t1  = 0x80004e88, (wrb) t0  <-- 12
#; .Lpcrel_hi5 (start.S:158)
#;   sub       sp, sp, t0
            531000    0x80000194 sub sp, sp, t0                 #; sp  = 0x1001e7a8, t0  = 12, (wrb) sp  <-- 0x1001e79c
#; .Lpcrel_hi6 (start.S:159)
#;   la        t0, __tbss_end
            532000    0x80000198 auipc t0, 5                    #; (wrb) t0  <-- 0x80005198
            533000    0x8000019c addi t0, t0, -704              #; t0  = 0x80005198, (wrb) t0  <-- 0x80004ed8
#; .Lpcrel_hi7 (start.S:160)
#;   la        t1, __tbss_start
            534000    0x800001a0 auipc t1, 5                    #; (wrb) t1  <-- 0x800051a0
            535000    0x800001a4 addi t1, t1, -776              #; t1  = 0x800051a0, (wrb) t1  <-- 0x80004e98
#; .Lpcrel_hi7 (start.S:161)
#;   sub       t0, t0, t1
            536000    0x800001a8 sub t0, t0, t1                 #; t0  = 0x80004ed8, t1  = 0x80004e98, (wrb) t0  <-- 64
...
#;   call snrt_main
            541000    0x800001bc auipc ra, 3                    #; (wrb) ra  <-- 0x800031bc
            542000    0x800001c0 jalr -616(ra)                  #; ra  = 0x800031bc, (wrb) ra  <-- 0x800001c4, goto 0x80002f54
#; snrt_main (start.c:204)
#;   EXTERN_C void snrt_main() {
            547000    0x80002f54 addi sp, sp, -48               #; sp  = 0x1001e758, (wrb) sp  <-- 0x1001e728
            548000    0x80002f58 sw ra, 44(sp)                  #; sp  = 0x1001e728, 0x800001c4 ~~> Word[0x1001e754]
            549000    0x80002f5c sw s0, 40(sp)                  #; sp  = 0x1001e728, 0 ~~> Word[0x1001e750]
            552000    0x80002f60 sw s1, 36(sp)                  #; sp  = 0x1001e728, 0 ~~> Word[0x1001e74c]
            554000    0x80002f64 sw s2, 32(sp)                  #; sp  = 0x1001e728, 0 ~~> Word[0x1001e748]
            555000    0x80002f68 sw s3, 28(sp)                  #; sp  = 0x1001e728, 0 ~~> Word[0x1001e744]
            556000    0x80002f6c sw s4, 24(sp)                  #; sp  = 0x1001e728, 0 ~~> Word[0x1001e740]
            557000    0x80002f70 sw s5, 20(sp)                  #; sp  = 0x1001e728, 0 ~~> Word[0x1001e73c]
            558000    0x80002f74 sw s6, 16(sp)                  #; sp  = 0x1001e728, 0 ~~> Word[0x1001e738]
            559000    0x80002f78 sw s7, 12(sp)                  #; sp  = 0x1001e728, 0 ~~> Word[0x1001e734]
            560000    0x80002f7c sw s8, 8(sp)                   #; sp  = 0x1001e728, 0 ~~> Word[0x1001e730]
            561000    0x80002f80 sw s9, 4(sp)                   #; sp  = 0x1001e728, 0 ~~> Word[0x1001e72c]
            562000    0x80002f84 sw s10, 0(sp)                  #; sp  = 0x1001e728, 0 ~~> Word[0x1001e728]
            563000    0x80002f88 li s3, -1                      #; (wrb) s3  <-- -1
...
#;         ^
            564000    0x80002f8c csrr s2, mhartid               #; mhartid = 6, (wrb) s2  <-- 6
            565000    0x80002f90 lui a0, 233017                 #; (wrb) a0  <-- 0x38e39000
            566000    0x80002f94 addi a0, a0, -455              #; a0  = 0x38e39000, (wrb) a0  <-- 0x38e38e39
#; snrt_main (start.c:206:9)
#;   snrt_cluster_idx (team.h:99:35)
#;     return snrt_global_core_idx() / snrt_cluster_core_num();
#;                                   ^
            567000    0x80002f98 mulhu a0, s2, a0               #; s2  = 6, a0  = 0x38e38e39
            569000                                              #; (acc) a0  <-- 1
            570000    0x80002f9c srli a0, a0, 1                 #; a0  = 1, (wrb) a0  <-- 0
            571000    0x80002fa0 li a1, 9                       #; (wrb) a1  <-- 9
            572000    0x80002fa4 slli s6, a0, 18                #; a0  = 0, (wrb) s6  <-- 0
#; snrt_main (start.c:206:9)
#;   if (snrt_cluster_idx() == 0) {
#;       ^
            573000    0x80002fa8 bgeu s2, a1, 136               #; s2  = 6, a1  = 9, not taken
...
#;         return snrt_global_core_idx() % snrt_cluster_core_num();
#;                                       ^
            574000    0x80002fac .text                          #; s2  = 6
            575000    0x80002fb0 li a1, 57                      #; (wrb) a1  <-- 57
            576000                                              #; (acc) a0  <-- 6
            577000    0x80002fb4 mul a0, a0, a1                 #; a0  = 6, a1  = 57
            579000                                              #; (acc) a0  <-- 342
            580000    0x80002fb8 srli a0, a0, 9                 #; a0  = 342, (wrb) a0  <-- 0
            581000    0x80002fbc slli a1, a0, 3                 #; a0  = 0, (wrb) a1  <-- 0
            582000    0x80002fc0 add a0, a1, a0                 #; a1  = 0, a0  = 0, (wrb) a0  <-- 0
            583000    0x80002fc4 sub a1, s2, a0                 #; s2  = 6, a0  = 0, (wrb) a1  <-- 6
            584000    0x80002fc8 lui a0, 65569                  #; (wrb) a0  <-- 0x10021000
            585000    0x80002fcc addi a0, a0, 424               #; a0  = 0x10021000, (wrb) a0  <-- 0x100211a8
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
...
#;                                                         ^
            586000    0x80002fd0 add a2, s6, a0                 #; s6  = 0, a0  = 0x100211a8, (wrb) a2  <-- 0x100211a8
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;     snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:5)
...
#;         snrt_cluster()->peripheral_reg.cl_clint_clear.f.cl_clint_clear = mask;
#;                                                                        ^
            587000    0x80002fd4 lw a0, 0(a2)                   #; a2  = 0x100211a8, a0  <~~ Word[0x100211a8]
            588000    0x80002fd8 ori a3, a2, 4                  #; a2  = 0x100211a8, (wrb) a3  <-- 0x100211ac
            589000    0x80002fdc lw a4, 0(a3)                   #; a3  = 0x100211ac, a4  <~~ Word[0x100211ac]
            613000                                              #; (lsu) a0  <-- 0
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;     snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:31)
...
#;         return snrt_global_core_idx() % snrt_cluster_core_num();
#;                                       ^
            614000    0x80002fe0 .text                          #; a1  = 6
            615000    0x80002fe4 li a5, 1                       #; (wrb) a5  <-- 1
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;     snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:28)
#;       snrt_int_cluster_clr(1 << snrt_cluster_core_idx());
#;                              ^
            616000    0x80002fe8 sll a5, a5, a1                 #; a5  = 1, a1  = 6, (wrb) a5  <-- 64
            617000                                              #; (acc) a0  <-- 6
            644000                                              #; (lsu) a4  <-- 0
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
...
#;         snrt_cluster()->peripheral_reg.cl_clint_clear.f.cl_clint_clear = mask;
#;                                                                        ^
            645000    0x80002fec and a4, a4, s3                 #; a4  = 0, s3  = -1, (wrb) a4  <-- 0
            646000    0x80002ff0 sw a4, 0(a3)                   #; a3  = 0x100211ac, 0 ~~> Word[0x100211ac]
            647000    0x80002ff4 sw a5, 0(a2)                   #; a2  = 0x100211a8, 64 ~~> Word[0x100211a8]
            648000    0x80002ff8 lui a2, 128                    #; (wrb) a2  <-- 0x00080000
...
#;              ^
            649000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            650000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            651000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            652000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            653000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            654000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            655000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            656000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            657000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            658000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            659000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            660000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            661000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            662000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            663000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            664000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            665000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            666000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            667000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            668000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            669000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            670000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            671000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            672000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            673000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            674000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            675000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            676000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            677000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            678000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            679000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            680000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            681000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            682000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            683000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            684000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            685000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            686000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            687000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            688000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            689000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            690000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            691000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            692000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            693000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            694000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            695000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            696000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            697000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            698000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            699000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            700000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            701000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            702000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            703000    0x80002ffc csrr a3, mip                   #; mip = 0, (wrb) a3  <-- 0
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            704000    0x80003000 and a3, a3, a2                 #; a3  = 0, a2  = 0x00080000, (wrb) a3  <-- 0
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            705000    0x80003004 bnez a3, -8                    #; a3  = 0, not taken
            706000    0x80003008 li a2, 8                       #; (wrb) a2  <-- 8
#; .LBB25_2 (start.c:206:28)
#;   if (snrt_cluster_idx() == 0) {
#;                          ^
            707000    0x8000300c sltu a2, a2, s2                #; a2  = 8, s2  = 6, (wrb) a2  <-- 0
            708000    0x80003010 .text                          #; a1  = 6
            710000                                              #; (acc) a1  <-- 6
            711000    0x80003014 snez a3, a1                    #; a1  = 6, (wrb) a3  <-- 1
#; .LBB25_2 (start.c:221:5)
#;   snrt_wake_up (start.c:124:33)
#;     if (snrt_cluster_idx() == 0 && snrt_cluster_core_idx() == 0) {
#;                                 ^
            712000    0x80003018 or a2, a2, a3                  #; a2  = 0, a3  = 1, (wrb) a2  <-- 1
            713000    0x8000301c seqz s5, a1                    #; a1  = 6, (wrb) s5  <-- 0
            714000    0x80003020 bnez a2, 32                    #; a2  = 1, taken, goto 0x80003040
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:137:5)
#;     snrt_cluster_hw_barrier (sync.h:174:5)
#;       asm volatile("csrr x0, 0x7C2" ::: "memory");
#;       ^
            715000    0x80003040 csrr zero, 1986                #; csr@7c2 = 0
...
#;                                                                          ^
            ...
            756000                                              #; (lsu) a1  <-- 0
            757000    0x80003054 ori a1, s4, 4                  #; s4  = 0x100211a8, (wrb) a1  <-- 0x100211ac
            758000    0x80003058 lw a2, 0(a1)                   #; a1  = 0x100211ac, a2  <~~ Word[0x100211ac]
            759000    0x8000305c li a3, 1                       #; (wrb) a3  <-- 1
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;       snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:28)
#;         snrt_int_cluster_clr(1 << snrt_cluster_core_idx());
#;                                ^
            760000    0x80003060 sll a3, a3, a0                 #; a3  = 1, a0  = 6, (wrb) a3  <-- 64
            782000                                              #; (lsu) a2  <-- 0
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:48:5)
...
#;           snrt_cluster()->peripheral_reg.cl_clint_clear.f.cl_clint_clear = mask;
#;                                                                          ^
            783000    0x80003064 and a2, a2, s3                 #; a2  = 0, s3  = -1, (wrb) a2  <-- 0
            784000    0x80003068 sw a3, 0(s4)                   #; s4  = 0x100211a8, 64 ~~> Word[0x100211a8]
            785000    0x8000306c sw a2, 0(a1)                   #; a1  = 0x100211ac, 0 ~~> Word[0x100211ac]
            786000    0x80003070 lui a1, 128                    #; (wrb) a1  <-- 0x00080000
...
#;         while (read_csr(mip) & MIP_MCIP)
#;                ^
            787000    0x80003074 csrr a2, mip                   #; mip = 0, (wrb) a2  <-- 0
#; .LBB25_7 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;       snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;         while (read_csr(mip) & MIP_MCIP)
#;                              ^
            788000    0x80003078 and a2, a2, a1                 #; a2  = 0, a1  = 0x00080000, (wrb) a2  <-- 0
#; .LBB25_7 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;       snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;         while (read_csr(mip) & MIP_MCIP)
#;         ^
            789000    0x8000307c bnez a2, -8                    #; a2  = 0, not taken
            793000    0x80003080 auipc s0, 2                    #; (wrb) s0  <-- 0x80005080
            794000    0x80003084 addi s0, s0, -424              #; s0  = 0x80005080, (wrb) s0  <-- 0x80004ed8
            795000    0x80003088 auipc s8, 2                    #; (wrb) s8  <-- 0x80005088
            796000    0x8000308c addi s8, s8, -432              #; s8  = 0x80005088, (wrb) s8  <-- 0x80004ed8
            797000    0x80003090 auipc s9, 2                    #; (wrb) s9  <-- 0x80005090
            798000    0x80003094 addi s9, s9, -408              #; s9  = 0x80005090, (wrb) s9  <-- 0x80004ef8
            799000    0x80003098 auipc s10, 2                   #; (wrb) s10 <-- 0x80005098
            800000    0x8000309c addi s10, s10, -448            #; s10 = 0x80005098, (wrb) s10 <-- 0x80004ed8
            801000    0x800030a0 auipc s7, 4                    #; (wrb) s7  <-- 0x800070a0
            802000    0x800030a4 addi s7, s7, 1480              #; s7  = 0x800070a0, (wrb) s7  <-- 0x80007668
#; .LBB25_33 (start.c:239:5)
#;   snrt_init_cls (start.c:166:13)
#;     if (snrt_cluster_core_idx() == 0) {
#;         ^
            803000    0x800030a8 beqz s5, 120                   #; s5  = 0, taken, goto 0x80003120
#; .LBB25_14 (start.c:239:5)
#;   snrt_init_cls (start.c:182:14)
#;     _cls_ptr = (cls_t*)snrt_cls_base_addr();
#;              ^
            810000    0x80003120 sub a1, s8, s0                 #; s8  = 0x80004ed8, s0  = 0x80004ed8, (wrb) a1  <-- 0
            811000    0x80003124 add a1, a1, s9                 #; a1  = 0, s9  = 0x80004ef8, (wrb) a1  <-- 0x80004ef8
            812000    0x80003128 sub a2, s10, a1                #; s10 = 0x80004ed8, a1  = 0x80004ef8, (wrb) a2  <-- -32
            813000    0x8000312c lui a1, 65568                  #; (wrb) a1  <-- 0x10020000
            814000    0x80003130 add a3, a2, a1                 #; a2  = -32, a1  = 0x10020000, (wrb) a3  <-- 0x1001ffe0
            815000    0x80003134 lui a2, 0                      #; (wrb) a2  <-- 0
            816000    0x80003138 add a2, a2, tp                 #; a2  = 0, tp  = 0x1001e758, (wrb) a2  <-- 0x1001e758
            817000    0x8000313c sw a3, 64(a2)                  #; a2  = 0x1001e758, 0x1001ffe0 ~~> Word[0x1001e798]
#; .LBB25_14 (start.c:239:5)
#;   snrt_init_cls (start.c:183:5)
#;     snrt_cluster_hw_barrier (sync.h:174:5)
#;       asm volatile("csrr x0, 0x7C2" ::: "memory");
#;       ^
            818000    0x80003140 csrr zero, 1986                #; csr@7c2 = 0
...
#;       if (snrt_is_dm_core()) {
#;           ^
            852000    0x80003148 bltu a0, a3, 84                #; a0  = 6, a3  = 8, taken, goto 0x8000319c
...
#;                                    ^
            ...
            887000    0x800031ac add a1, a1, tp                 #; a1  = 0, tp  = 0x1001e758, (wrb) a1  <-- 0x1001e758
            888000    0x800031b0 sw zero, 20(a1)                #; a1  = 0x1001e758, 0 ~~> Word[0x1001e76c]
            889000    0x800031b4 sw a0, 16(a1)                  #; a1  = 0x1001e758, 0x10000000 ~~> Word[0x1001e768]
            890000    0x800031b8 addi a1, a1, 16                #; a1  = 0x1001e758, (wrb) a1  <-- 0x1001e768
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:190:5)
#;     snrt_l1_init (alloc_v2.h:119:33)
#;       snrt_l1_allocator_v2()->end = heap_end_addr;
#;                                   ^
            891000    0x800031bc sw zero, 12(a1)                #; a1  = 0x1001e768, 0 ~~> Word[0x1001e774]
            ...
            898000    0x800031d8 sw a2, 8(a1)                   #; a1  = 0x1001e768, 0x1001db60 ~~> Word[0x1001e770]
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:190:5)
#;     snrt_l1_init (alloc_v2.h:120:34)
#;       snrt_l1_allocator_v2()->next = snrt_l1_allocator_v2()->base;
#;                                    ^
            899000    0x800031dc sw zero, 20(a1)                #; a1  = 0x1001e768, 0 ~~> Word[0x1001e77c]
            900000    0x800031e0 sw a0, 16(a1)                  #; a1  = 0x1001e768, 0x10000000 ~~> Word[0x1001e778]
#; .LBB25_16 (start.c:247:5)
...
#;                                    ^
            ...
            902000    0x800031e8 add a0, a0, tp                 #; a0  = 0, tp  = 0x1001e758, (wrb) a0  <-- 0x1001e758
            903000    0x800031ec sw zero, 44(a0)                #; a0  = 0x1001e758, 0 ~~> Word[0x1001e784]
            ...
            906000    0x800031f8 sw a1, 40(a0)                  #; a0  = 0x1001e758, 0x80007668 ~~> Word[0x1001e780]
            907000    0x800031fc addi a0, a0, 40                #; a0  = 0x1001e758, (wrb) a0  <-- 0x1001e780
...
#;                                   ^
            909000    0x80003204 sw a2, 12(a0)                  #; a0  = 0x1001e780, 1 ~~> Word[0x1001e78c]
            910000    0x80003208 sw zero, 8(a0)                 #; a0  = 0x1001e780, 0 ~~> Word[0x1001e788]
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:191:5)
#;     snrt_l3_init (alloc_v2.h:187:34)
#;       snrt_l3_allocator_v2()->next = snrt_l3_allocator_v2()->base;
#;                                    ^
            911000    0x8000320c sw zero, 20(a0)                #; a0  = 0x1001e780, 0 ~~> Word[0x1001e794]
            912000    0x80003210 sw a1, 16(a0)                  #; a0  = 0x1001e780, 0x80007668 ~~> Word[0x1001e790]
#; .LBB25_16 (start.c:247:5)
...
#;                                                      ^
            ...
            914000    0x80003218 add s0, a0, tp                 #; a0  = 0, tp  = 0x1001e758, (wrb) s0  <-- 0x1001e758
            915000    0x8000321c lui a0, 0                      #; (wrb) a0  <-- 0
            916000    0x80003220 add a0, a0, tp                 #; a0  = 0, tp  = 0x1001e758, (wrb) a0  <-- 0x1001e758
            917000    0x80003224 mv a0, a0                      #; a0  = 0x1001e758, (wrb) a0  <-- 0x1001e758
            918000    0x80003228 sw a0, 76(s0)                  #; s0  = 0x1001e758, 0x1001e758 ~~> Word[0x1001e7a4]
...
#;       asm("csrr %0, mhartid" : "=r"(hartid));
#;       ^
            944000    0x800001d0 csrr a0, mhartid               #; mhartid = 6, (wrb) a0  <-- 6
            945000    0x800001d4 li a1, 2                       #; (wrb) a1  <-- 2
#; main (xpulp_abs.c:8:8)
#;   if (i == 2) {
#;       ^
            946000    0x800001d8 bne a0, a1, 24                 #; a0  = 6, a1  = 2, taken, goto 0x800001f0
...
#;                                        ^
            ...
            957000    0x80003240 add a1, a1, tp                 #; a1  = 0, tp  = 0x1001e758, (wrb) a1  <-- 0x1001e758
            958000    0x80003244 lw a1, 64(a1)                  #; a1  = 0x1001e758, a1  <~~ Word[0x1001e798]
...
#;           ^
            985000    0x80003250 mv a0, a0                      #; a0  = 0, (wrb) a0  <-- 0
#; .LBB25_16 (start.c:280:5)
#;   snrt_exit (start.h:20:40)
#;     snrt_exit_default (start.h:11:17)
...
#;           asm volatile("csrr x0, 0x7C2" ::: "memory");
#;           ^
            986000    0x80003254 csrr zero, 1986                #; csr@7c2 = 0
#; .LBB25_16 (start.c:280:5)
#;   snrt_exit (start.h:20:40)
#;     snrt_exit_default (start.h:11:17)
...
#;         if (snrt_cluster_core_idx() == 0) {
#;             ^
            994000    0x80003258 beqz s5, 84                    #; s5  = 0, taken, goto 0x800032ac
#; .LBB25_21 (start.c:280:5)
#;   snrt_exit (start.h:20:40)
#;     snrt_exit_default (start.h:11:17)
...
#;             asm volatile("csrr x0, 0x7C2" ::: "memory");
#;             ^
            995000    0x800032ac csrr zero, 1986                #; csr@7c2 = 0

## Performance metrics

Performance metrics for section 0 @ (16, 993):
tstart                                          18
snitch_loads                                     7
snitch_stores                                   31
tend                                           995
fpss_loads                                       0
snitch_avg_load_latency                      25.14
snitch_occupancy                            0.3016
snitch_fseq_rel_offloads                   0.09786
fseq_yield                                     1.0
fseq_fpu_yield                                 1.0
fpss_section_latency                             0
fpss_avg_fpu_latency                           2.0
fpss_avg_load_latency                            0
fpss_occupancy                             0.03272
fpss_fpu_occupancy                         0.03272
