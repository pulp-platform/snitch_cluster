...
#;   EXTERN_C void snrt_main() {
            543000    0x80002f54 addi sp, sp, -48               #; sp  = 0x1001f370, (wrb) sp  <-- 0x1001f340
            544000    0x80002f58 sw ra, 44(sp)                  #; sp  = 0x1001f340, 0x800001c4 ~~> Word[0x1001f36c]
            545000    0x80002f5c sw s0, 40(sp)                  #; sp  = 0x1001f340, 0 ~~> Word[0x1001f368]
            546000    0x80002f60 sw s1, 36(sp)                  #; sp  = 0x1001f340, 0 ~~> Word[0x1001f364]
            547000    0x80002f64 sw s2, 32(sp)                  #; sp  = 0x1001f340, 0 ~~> Word[0x1001f360]
            548000    0x80002f68 sw s3, 28(sp)                  #; sp  = 0x1001f340, 0 ~~> Word[0x1001f35c]
            549000    0x80002f6c sw s4, 24(sp)                  #; sp  = 0x1001f340, 0 ~~> Word[0x1001f358]
            550000    0x80002f70 sw s5, 20(sp)                  #; sp  = 0x1001f340, 0 ~~> Word[0x1001f354]
            551000    0x80002f74 sw s6, 16(sp)                  #; sp  = 0x1001f340, 0 ~~> Word[0x1001f350]
            553000    0x80002f78 sw s7, 12(sp)                  #; sp  = 0x1001f340, 0 ~~> Word[0x1001f34c]
            555000    0x80002f7c sw s8, 8(sp)                   #; sp  = 0x1001f340, 0 ~~> Word[0x1001f348]
            557000    0x80002f80 sw s9, 4(sp)                   #; sp  = 0x1001f340, 0 ~~> Word[0x1001f344]
            558000    0x80002f84 sw s10, 0(sp)                  #; sp  = 0x1001f340, 0 ~~> Word[0x1001f340]
...
#;         ^
            560000    0x80002f8c csrr s2, mhartid               #; mhartid = 3, (wrb) s2  <-- 3
...
#;                                   ^
            563000    0x80002f98 mulhu a0, s2, a0               #; s2  = 3, a0  = 0x38e38e39
            565000                                              #; (acc) a0  <-- 0
            566000    0x80002f9c srli a0, a0, 1                 #; a0  = 0, (wrb) a0  <-- 0
            567000    0x80002fa0 li a1, 9                       #; (wrb) a1  <-- 9
            568000    0x80002fa4 slli s6, a0, 18                #; a0  = 0, (wrb) s6  <-- 0
#; snrt_main (start.c:206:9)
#;   if (snrt_cluster_idx() == 0) {
#;       ^
            569000    0x80002fa8 bgeu s2, a1, 136               #; s2  = 3, a1  = 9, not taken
...
#;         return snrt_global_core_idx() % snrt_cluster_core_num();
#;                                       ^
            570000    0x80002fac .text                          #; s2  = 3
            571000    0x80002fb0 li a1, 57                      #; (wrb) a1  <-- 57
            572000                                              #; (acc) a0  <-- 3
            573000    0x80002fb4 mul a0, a0, a1                 #; a0  = 3, a1  = 57
            575000                                              #; (acc) a0  <-- 171
            576000    0x80002fb8 srli a0, a0, 9                 #; a0  = 171, (wrb) a0  <-- 0
            577000    0x80002fbc slli a1, a0, 3                 #; a0  = 0, (wrb) a1  <-- 0
            578000    0x80002fc0 add a0, a1, a0                 #; a1  = 0, a0  = 0, (wrb) a0  <-- 0
            579000    0x80002fc4 sub a1, s2, a0                 #; s2  = 3, a0  = 0, (wrb) a1  <-- 3
...
#;         return snrt_global_core_idx() % snrt_cluster_core_num();
#;                                       ^
            604000    0x80002fe0 .text                          #; a1  = 3
            605000    0x80002fe4 li a5, 1                       #; (wrb) a5  <-- 1
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;     snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:28)
#;       snrt_int_cluster_clr(1 << snrt_cluster_core_idx());
#;                              ^
            606000    0x80002fe8 sll a5, a5, a1                 #; a5  = 1, a1  = 3, (wrb) a5  <-- 8
            607000                                              #; (acc) a0  <-- 3
            631000                                              #; (lsu) a4  <-- 0
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
...
#;         snrt_cluster()->peripheral_reg.cl_clint_clear.f.cl_clint_clear = mask;
#;                                                                        ^
            632000    0x80002fec and a4, a4, s3                 #; a4  = 0, s3  = -1, (wrb) a4  <-- 0
            633000    0x80002ff0 sw a4, 0(a3)                   #; a3  = 0x100211ac, 0 ~~> Word[0x100211ac]
            634000    0x80002ff4 sw a5, 0(a2)                   #; a2  = 0x100211a8, 8 ~~> Word[0x100211a8]
            635000    0x80002ff8 lui a2, 128                    #; (wrb) a2  <-- 0x00080000
...
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            696000    0x80002ffc csrr a3, mip                   #; mip = 0, (wrb) a3  <-- 0
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            697000    0x80003000 and a3, a3, a2                 #; a3  = 0, a2  = 0x00080000, (wrb) a3  <-- 0
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            698000    0x80003004 bnez a3, -8                    #; a3  = 0, not taken
            699000    0x80003008 li a2, 8                       #; (wrb) a2  <-- 8
#; .LBB25_2 (start.c:206:28)
#;   if (snrt_cluster_idx() == 0) {
#;                          ^
            700000    0x8000300c sltu a2, a2, s2                #; a2  = 8, s2  = 3, (wrb) a2  <-- 0
            701000    0x80003010 .text                          #; a1  = 3
            703000                                              #; (acc) a1  <-- 3
            704000    0x80003014 snez a3, a1                    #; a1  = 3, (wrb) a3  <-- 1
#; .LBB25_2 (start.c:221:5)
#;   snrt_wake_up (start.c:124:33)
#;     if (snrt_cluster_idx() == 0 && snrt_cluster_core_idx() == 0) {
#;                                 ^
            705000    0x80003018 or a2, a2, a3                  #; a2  = 0, a3  = 1, (wrb) a2  <-- 1
            706000    0x8000301c seqz s5, a1                    #; a1  = 3, (wrb) s5  <-- 0
            707000    0x80003020 bnez a2, 32                    #; a2  = 1, taken, goto 0x80003040
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:137:5)
#;     snrt_cluster_hw_barrier (sync.h:174:5)
#;       asm volatile("csrr x0, 0x7C2" ::: "memory");
#;       ^
            708000    0x80003040 csrr zero, 1986                #; csr@7c2 = 0
...
#;                                                                          ^
            ...
            746000                                              #; (lsu) a1  <-- 0
            747000    0x80003054 ori a1, s4, 4                  #; s4  = 0x100211a8, (wrb) a1  <-- 0x100211ac
            748000    0x80003058 lw a2, 0(a1)                   #; a1  = 0x100211ac, a2  <~~ Word[0x100211ac]
            749000    0x8000305c li a3, 1                       #; (wrb) a3  <-- 1
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;       snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:28)
#;         snrt_int_cluster_clr(1 << snrt_cluster_core_idx());
#;                                ^
            750000    0x80003060 sll a3, a3, a0                 #; a3  = 1, a0  = 3, (wrb) a3  <-- 8
            774000                                              #; (lsu) a2  <-- 0
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:48:5)
...
#;           snrt_cluster()->peripheral_reg.cl_clint_clear.f.cl_clint_clear = mask;
#;                                                                          ^
            775000    0x80003064 and a2, a2, s3                 #; a2  = 0, s3  = -1, (wrb) a2  <-- 0
            776000    0x80003068 sw a3, 0(s4)                   #; s4  = 0x100211a8, 8 ~~> Word[0x100211a8]
            777000    0x8000306c sw a2, 0(a1)                   #; a1  = 0x100211ac, 0 ~~> Word[0x100211ac]
            778000    0x80003070 lui a1, 128                    #; (wrb) a1  <-- 0x00080000
...
#;         while (read_csr(mip) & MIP_MCIP)
#;                ^
            779000    0x80003074 csrr a2, mip                   #; mip = 0, (wrb) a2  <-- 0
#; .LBB25_7 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;       snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;         while (read_csr(mip) & MIP_MCIP)
#;                              ^
            780000    0x80003078 and a2, a2, a1                 #; a2  = 0, a1  = 0x00080000, (wrb) a2  <-- 0
#; .LBB25_7 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;       snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;         while (read_csr(mip) & MIP_MCIP)
#;         ^
            781000    0x8000307c bnez a2, -8                    #; a2  = 0, not taken
            784000    0x80003080 auipc s0, 2                    #; (wrb) s0  <-- 0x80005080
            785000    0x80003084 addi s0, s0, -424              #; s0  = 0x80005080, (wrb) s0  <-- 0x80004ed8
            786000    0x80003088 auipc s8, 2                    #; (wrb) s8  <-- 0x80005088
            787000    0x8000308c addi s8, s8, -432              #; s8  = 0x80005088, (wrb) s8  <-- 0x80004ed8
            788000    0x80003090 auipc s9, 2                    #; (wrb) s9  <-- 0x80005090
            789000    0x80003094 addi s9, s9, -408              #; s9  = 0x80005090, (wrb) s9  <-- 0x80004ef8
            790000    0x80003098 auipc s10, 2                   #; (wrb) s10 <-- 0x80005098
            791000    0x8000309c addi s10, s10, -448            #; s10 = 0x80005098, (wrb) s10 <-- 0x80004ed8
            792000    0x800030a0 auipc s7, 4                    #; (wrb) s7  <-- 0x800070a0
            793000    0x800030a4 addi s7, s7, 1480              #; s7  = 0x800070a0, (wrb) s7  <-- 0x80007668
#; .LBB25_33 (start.c:239:5)
#;   snrt_init_cls (start.c:166:13)
#;     if (snrt_cluster_core_idx() == 0) {
#;         ^
            794000    0x800030a8 beqz s5, 120                   #; s5  = 0, taken, goto 0x80003120
...
#;              ^
            ...
            804000    0x80003138 add a2, a2, tp                 #; a2  = 0, tp  = 0x1001f370, (wrb) a2  <-- 0x1001f370
            805000    0x8000313c sw a3, 64(a2)                  #; a2  = 0x1001f370, 0x1001ffe0 ~~> Word[0x1001f3b0]
#; .LBB25_14 (start.c:239:5)
...
#;       if (snrt_is_dm_core()) {
#;           ^
            852000    0x80003148 bltu a0, a3, 84                #; a0  = 3, a3  = 8, taken, goto 0x8000319c
...
#;                                    ^
            ...
            887000    0x800031ac add a1, a1, tp                 #; a1  = 0, tp  = 0x1001f370, (wrb) a1  <-- 0x1001f370
            888000    0x800031b0 sw zero, 20(a1)                #; a1  = 0x1001f370, 0 ~~> Word[0x1001f384]
            889000    0x800031b4 sw a0, 16(a1)                  #; a1  = 0x1001f370, 0x10000000 ~~> Word[0x1001f380]
            890000    0x800031b8 addi a1, a1, 16                #; a1  = 0x1001f370, (wrb) a1  <-- 0x1001f380
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:190:5)
#;     snrt_l1_init (alloc_v2.h:119:33)
#;       snrt_l1_allocator_v2()->end = heap_end_addr;
#;                                   ^
            891000    0x800031bc sw zero, 12(a1)                #; a1  = 0x1001f380, 0 ~~> Word[0x1001f38c]
            ...
            898000    0x800031d8 sw a2, 8(a1)                   #; a1  = 0x1001f380, 0x1001db60 ~~> Word[0x1001f388]
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:190:5)
#;     snrt_l1_init (alloc_v2.h:120:34)
#;       snrt_l1_allocator_v2()->next = snrt_l1_allocator_v2()->base;
#;                                    ^
            899000    0x800031dc sw zero, 20(a1)                #; a1  = 0x1001f380, 0 ~~> Word[0x1001f394]
            900000    0x800031e0 sw a0, 16(a1)                  #; a1  = 0x1001f380, 0x10000000 ~~> Word[0x1001f390]
#; .LBB25_16 (start.c:247:5)
...
#;                                    ^
            ...
            902000    0x800031e8 add a0, a0, tp                 #; a0  = 0, tp  = 0x1001f370, (wrb) a0  <-- 0x1001f370
            903000    0x800031ec sw zero, 44(a0)                #; a0  = 0x1001f370, 0 ~~> Word[0x1001f39c]
            ...
            906000    0x800031f8 sw a1, 40(a0)                  #; a0  = 0x1001f370, 0x80007668 ~~> Word[0x1001f398]
            907000    0x800031fc addi a0, a0, 40                #; a0  = 0x1001f370, (wrb) a0  <-- 0x1001f398
...
#;                                   ^
            909000    0x80003204 sw a2, 12(a0)                  #; a0  = 0x1001f398, 1 ~~> Word[0x1001f3a4]
            910000    0x80003208 sw zero, 8(a0)                 #; a0  = 0x1001f398, 0 ~~> Word[0x1001f3a0]
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:191:5)
#;     snrt_l3_init (alloc_v2.h:187:34)
#;       snrt_l3_allocator_v2()->next = snrt_l3_allocator_v2()->base;
#;                                    ^
            911000    0x8000320c sw zero, 20(a0)                #; a0  = 0x1001f398, 0 ~~> Word[0x1001f3ac]
            912000    0x80003210 sw a1, 16(a0)                  #; a0  = 0x1001f398, 0x80007668 ~~> Word[0x1001f3a8]
#; .LBB25_16 (start.c:247:5)
...
#;                                                      ^
            ...
            914000    0x80003218 add s0, a0, tp                 #; a0  = 0, tp  = 0x1001f370, (wrb) s0  <-- 0x1001f370
            915000    0x8000321c lui a0, 0                      #; (wrb) a0  <-- 0
            916000    0x80003220 add a0, a0, tp                 #; a0  = 0, tp  = 0x1001f370, (wrb) a0  <-- 0x1001f370
            917000    0x80003224 mv a0, a0                      #; a0  = 0x1001f370, (wrb) a0  <-- 0x1001f370
            918000    0x80003228 sw a0, 76(s0)                  #; s0  = 0x1001f370, 0x1001f370 ~~> Word[0x1001f3bc]
...
#;       asm("csrr %0, mhartid" : "=r"(hartid));
#;       ^
            944000    0x800001d0 csrr a0, mhartid               #; mhartid = 3, (wrb) a0  <-- 3
            945000    0x800001d4 li a1, 2                       #; (wrb) a1  <-- 2
#; main (xpulp_abs.c:8:8)
#;   if (i == 2) {
#;       ^
            946000    0x800001d8 bne a0, a1, 24                 #; a0  = 3, a1  = 2, taken, goto 0x800001f0
...
#;                                        ^
            ...
            957000    0x80003240 add a1, a1, tp                 #; a1  = 0, tp  = 0x1001f370, (wrb) a1  <-- 0x1001f370
            958000    0x80003244 lw a1, 64(a1)                  #; a1  = 0x1001f370, a1  <~~ Word[0x1001f3b0]
...
Performance metrics for section 0 @ (11, 960):
tstart                                          13
snitch_loads                                     6
snitch_stores                                   31
tend                                           962
fpss_loads                                       0
snitch_avg_load_latency                      20.83
snitch_occupancy                            0.3116
snitch_fseq_rel_offloads                   0.09756
fseq_yield                                     1.0
fseq_fpu_yield                                 1.0
fpss_section_latency                             0
fpss_avg_fpu_latency                           2.0
fpss_avg_load_latency                            0
fpss_occupancy                             0.03368
fpss_fpu_occupancy                         0.03368
