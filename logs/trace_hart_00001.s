...
#;   EXTERN_C void snrt_main() {
            543000    0x80002f54 addi sp, sp, -48               #; sp  = 0x1001fb80, (wrb) sp  <-- 0x1001fb50
            544000    0x80002f58 sw ra, 44(sp)                  #; sp  = 0x1001fb50, 0x800001c4 ~~> Word[0x1001fb7c]
            545000    0x80002f5c sw s0, 40(sp)                  #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb78]
            546000    0x80002f60 sw s1, 36(sp)                  #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb74]
            547000    0x80002f64 sw s2, 32(sp)                  #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb70]
            548000    0x80002f68 sw s3, 28(sp)                  #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb6c]
            549000    0x80002f6c sw s4, 24(sp)                  #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb68]
            550000    0x80002f70 sw s5, 20(sp)                  #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb64]
            551000    0x80002f74 sw s6, 16(sp)                  #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb60]
            552000    0x80002f78 sw s7, 12(sp)                  #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb5c]
            553000    0x80002f7c sw s8, 8(sp)                   #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb58]
            556000    0x80002f80 sw s9, 4(sp)                   #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb54]
            557000    0x80002f84 sw s10, 0(sp)                  #; sp  = 0x1001fb50, 0 ~~> Word[0x1001fb50]
...
#;         ^
            559000    0x80002f8c csrr s2, mhartid               #; mhartid = 1, (wrb) s2  <-- 1
...
#;                                   ^
            562000    0x80002f98 mulhu a0, s2, a0               #; s2  = 1, a0  = 0x38e38e39
            564000                                              #; (acc) a0  <-- 0
...
#;       ^
            568000    0x80002fa8 bgeu s2, a1, 136               #; s2  = 1, a1  = 9, not taken
...
#;         return snrt_global_core_idx() % snrt_cluster_core_num();
#;                                       ^
            569000    0x80002fac .text                          #; s2  = 1
            570000    0x80002fb0 li a1, 57                      #; (wrb) a1  <-- 57
            571000                                              #; (acc) a0  <-- 1
            572000    0x80002fb4 mul a0, a0, a1                 #; a0  = 1, a1  = 57
            574000                                              #; (acc) a0  <-- 57
            575000    0x80002fb8 srli a0, a0, 9                 #; a0  = 57, (wrb) a0  <-- 0
            576000    0x80002fbc slli a1, a0, 3                 #; a0  = 0, (wrb) a1  <-- 0
            577000    0x80002fc0 add a0, a1, a0                 #; a1  = 0, a0  = 0, (wrb) a0  <-- 0
            578000    0x80002fc4 sub a1, s2, a0                 #; s2  = 1, a0  = 0, (wrb) a1  <-- 1
...
#;         return snrt_global_core_idx() % snrt_cluster_core_num();
#;                                       ^
            598000    0x80002fe0 .text                          #; a1  = 1
            599000    0x80002fe4 li a5, 1                       #; (wrb) a5  <-- 1
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;     snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:28)
#;       snrt_int_cluster_clr(1 << snrt_cluster_core_idx());
#;                              ^
            600000    0x80002fe8 sll a5, a5, a1                 #; a5  = 1, a1  = 1, (wrb) a5  <-- 2
            601000                                              #; (acc) a0  <-- 1
            625000                                              #; (lsu) a4  <-- 0
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
...
#;         snrt_cluster()->peripheral_reg.cl_clint_clear.f.cl_clint_clear = mask;
#;                                                                        ^
            626000    0x80002fec and a4, a4, s3                 #; a4  = 0, s3  = -1, (wrb) a4  <-- 0
            627000    0x80002ff0 sw a4, 0(a3)                   #; a3  = 0x100211ac, 0 ~~> Word[0x100211ac]
            628000    0x80002ff4 sw a5, 0(a2)                   #; a2  = 0x100211a8, 2 ~~> Word[0x100211a8]
            629000    0x80002ff8 lui a2, 128                    #; (wrb) a2  <-- 0x00080000
...
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            687000    0x80002ffc csrr a3, mip                   #; mip = 0, (wrb) a3  <-- 0
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            688000    0x80003000 and a3, a3, a2                 #; a3  = 0, a2  = 0x00080000, (wrb) a3  <-- 0
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            689000    0x80003004 bnez a3, -8                    #; a3  = 0, not taken
            690000    0x80003008 li a2, 8                       #; (wrb) a2  <-- 8
#; .LBB25_2 (start.c:206:28)
#;   if (snrt_cluster_idx() == 0) {
#;                          ^
            691000    0x8000300c sltu a2, a2, s2                #; a2  = 8, s2  = 1, (wrb) a2  <-- 0
            692000    0x80003010 .text                          #; a1  = 1
            694000                                              #; (acc) a1  <-- 1
            695000    0x80003014 snez a3, a1                    #; a1  = 1, (wrb) a3  <-- 1
#; .LBB25_2 (start.c:221:5)
#;   snrt_wake_up (start.c:124:33)
#;     if (snrt_cluster_idx() == 0 && snrt_cluster_core_idx() == 0) {
#;                                 ^
            696000    0x80003018 or a2, a2, a3                  #; a2  = 0, a3  = 1, (wrb) a2  <-- 1
            697000    0x8000301c seqz s5, a1                    #; a1  = 1, (wrb) s5  <-- 0
            698000    0x80003020 bnez a2, 32                    #; a2  = 1, taken, goto 0x80003040
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:137:5)
#;     snrt_cluster_hw_barrier (sync.h:174:5)
#;       asm volatile("csrr x0, 0x7C2" ::: "memory");
#;       ^
            699000    0x80003040 csrr zero, 1986                #; csr@7c2 = 0
...
#;                                                                          ^
            ...
            740000                                              #; (lsu) a1  <-- 0
            741000    0x80003054 ori a1, s4, 4                  #; s4  = 0x100211a8, (wrb) a1  <-- 0x100211ac
            742000    0x80003058 lw a2, 0(a1)                   #; a1  = 0x100211ac, a2  <~~ Word[0x100211ac]
            743000    0x8000305c li a3, 1                       #; (wrb) a3  <-- 1
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;       snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:28)
#;         snrt_int_cluster_clr(1 << snrt_cluster_core_idx());
#;                                ^
            744000    0x80003060 sll a3, a3, a0                 #; a3  = 1, a0  = 1, (wrb) a3  <-- 2
            768000                                              #; (lsu) a2  <-- 0
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:48:5)
...
#;           snrt_cluster()->peripheral_reg.cl_clint_clear.f.cl_clint_clear = mask;
#;                                                                          ^
            769000    0x80003064 and a2, a2, s3                 #; a2  = 0, s3  = -1, (wrb) a2  <-- 0
            770000    0x80003068 sw a3, 0(s4)                   #; s4  = 0x100211a8, 2 ~~> Word[0x100211a8]
            771000    0x8000306c sw a2, 0(a1)                   #; a1  = 0x100211ac, 0 ~~> Word[0x100211ac]
            772000    0x80003070 lui a1, 128                    #; (wrb) a1  <-- 0x00080000
...
#;         while (read_csr(mip) & MIP_MCIP)
#;                ^
            773000    0x80003074 csrr a2, mip                   #; mip = 0, (wrb) a2  <-- 0
#; .LBB25_7 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;       snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;         while (read_csr(mip) & MIP_MCIP)
#;                              ^
            774000    0x80003078 and a2, a2, a1                 #; a2  = 0, a1  = 0x00080000, (wrb) a2  <-- 0
#; .LBB25_7 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;       snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;         while (read_csr(mip) & MIP_MCIP)
#;         ^
            775000    0x8000307c bnez a2, -8                    #; a2  = 0, not taken
            778000    0x80003080 auipc s0, 2                    #; (wrb) s0  <-- 0x80005080
            779000    0x80003084 addi s0, s0, -424              #; s0  = 0x80005080, (wrb) s0  <-- 0x80004ed8
            780000    0x80003088 auipc s8, 2                    #; (wrb) s8  <-- 0x80005088
            781000    0x8000308c addi s8, s8, -432              #; s8  = 0x80005088, (wrb) s8  <-- 0x80004ed8
            782000    0x80003090 auipc s9, 2                    #; (wrb) s9  <-- 0x80005090
            783000    0x80003094 addi s9, s9, -408              #; s9  = 0x80005090, (wrb) s9  <-- 0x80004ef8
            784000    0x80003098 auipc s10, 2                   #; (wrb) s10 <-- 0x80005098
            785000    0x8000309c addi s10, s10, -448            #; s10 = 0x80005098, (wrb) s10 <-- 0x80004ed8
            786000    0x800030a0 auipc s7, 4                    #; (wrb) s7  <-- 0x800070a0
            787000    0x800030a4 addi s7, s7, 1480              #; s7  = 0x800070a0, (wrb) s7  <-- 0x80007668
#; .LBB25_33 (start.c:239:5)
#;   snrt_init_cls (start.c:166:13)
#;     if (snrt_cluster_core_idx() == 0) {
#;         ^
            788000    0x800030a8 beqz s5, 120                   #; s5  = 0, taken, goto 0x80003120
...
#;              ^
            ...
            804000    0x80003138 add a2, a2, tp                 #; a2  = 0, tp  = 0x1001fb80, (wrb) a2  <-- 0x1001fb80
            805000    0x8000313c sw a3, 64(a2)                  #; a2  = 0x1001fb80, 0x1001ffe0 ~~> Word[0x1001fbc0]
#; .LBB25_14 (start.c:239:5)
...
#;       if (snrt_is_dm_core()) {
#;           ^
            852000    0x80003148 bltu a0, a3, 84                #; a0  = 1, a3  = 8, taken, goto 0x8000319c
...
#;                                    ^
            ...
            887000    0x800031ac add a1, a1, tp                 #; a1  = 0, tp  = 0x1001fb80, (wrb) a1  <-- 0x1001fb80
            888000    0x800031b0 sw zero, 20(a1)                #; a1  = 0x1001fb80, 0 ~~> Word[0x1001fb94]
            889000    0x800031b4 sw a0, 16(a1)                  #; a1  = 0x1001fb80, 0x10000000 ~~> Word[0x1001fb90]
            890000    0x800031b8 addi a1, a1, 16                #; a1  = 0x1001fb80, (wrb) a1  <-- 0x1001fb90
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:190:5)
#;     snrt_l1_init (alloc_v2.h:119:33)
#;       snrt_l1_allocator_v2()->end = heap_end_addr;
#;                                   ^
            891000    0x800031bc sw zero, 12(a1)                #; a1  = 0x1001fb90, 0 ~~> Word[0x1001fb9c]
            ...
            898000    0x800031d8 sw a2, 8(a1)                   #; a1  = 0x1001fb90, 0x1001db60 ~~> Word[0x1001fb98]
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:190:5)
#;     snrt_l1_init (alloc_v2.h:120:34)
#;       snrt_l1_allocator_v2()->next = snrt_l1_allocator_v2()->base;
#;                                    ^
            899000    0x800031dc sw zero, 20(a1)                #; a1  = 0x1001fb90, 0 ~~> Word[0x1001fba4]
            900000    0x800031e0 sw a0, 16(a1)                  #; a1  = 0x1001fb90, 0x10000000 ~~> Word[0x1001fba0]
#; .LBB25_16 (start.c:247:5)
...
#;                                    ^
            ...
            902000    0x800031e8 add a0, a0, tp                 #; a0  = 0, tp  = 0x1001fb80, (wrb) a0  <-- 0x1001fb80
            903000    0x800031ec sw zero, 44(a0)                #; a0  = 0x1001fb80, 0 ~~> Word[0x1001fbac]
            ...
            906000    0x800031f8 sw a1, 40(a0)                  #; a0  = 0x1001fb80, 0x80007668 ~~> Word[0x1001fba8]
            907000    0x800031fc addi a0, a0, 40                #; a0  = 0x1001fb80, (wrb) a0  <-- 0x1001fba8
...
#;                                   ^
            909000    0x80003204 sw a2, 12(a0)                  #; a0  = 0x1001fba8, 1 ~~> Word[0x1001fbb4]
            910000    0x80003208 sw zero, 8(a0)                 #; a0  = 0x1001fba8, 0 ~~> Word[0x1001fbb0]
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:191:5)
#;     snrt_l3_init (alloc_v2.h:187:34)
#;       snrt_l3_allocator_v2()->next = snrt_l3_allocator_v2()->base;
#;                                    ^
            911000    0x8000320c sw zero, 20(a0)                #; a0  = 0x1001fba8, 0 ~~> Word[0x1001fbbc]
            912000    0x80003210 sw a1, 16(a0)                  #; a0  = 0x1001fba8, 0x80007668 ~~> Word[0x1001fbb8]
#; .LBB25_16 (start.c:247:5)
...
#;                                                      ^
            ...
            914000    0x80003218 add s0, a0, tp                 #; a0  = 0, tp  = 0x1001fb80, (wrb) s0  <-- 0x1001fb80
            915000    0x8000321c lui a0, 0                      #; (wrb) a0  <-- 0
            916000    0x80003220 add a0, a0, tp                 #; a0  = 0, tp  = 0x1001fb80, (wrb) a0  <-- 0x1001fb80
            917000    0x80003224 mv a0, a0                      #; a0  = 0x1001fb80, (wrb) a0  <-- 0x1001fb80
            918000    0x80003228 sw a0, 76(s0)                  #; s0  = 0x1001fb80, 0x1001fb80 ~~> Word[0x1001fbcc]
...
#;       asm("csrr %0, mhartid" : "=r"(hartid));
#;       ^
            944000    0x800001d0 csrr a0, mhartid               #; mhartid = 1, (wrb) a0  <-- 1
            945000    0x800001d4 li a1, 2                       #; (wrb) a1  <-- 2
#; main (xpulp_abs.c:8:8)
#;   if (i == 2) {
#;       ^
            946000    0x800001d8 bne a0, a1, 24                 #; a0  = 1, a1  = 2, taken, goto 0x800001f0
...
#;                                        ^
            ...
            957000    0x80003240 add a1, a1, tp                 #; a1  = 0, tp  = 0x1001fb80, (wrb) a1  <-- 0x1001fb80
            958000    0x80003244 lw a1, 64(a1)                  #; a1  = 0x1001fb80, a1  <~~ Word[0x1001fbc0]
...
#;           ^
            970000    0x80003250 mv a0, a0                      #; a0  = 0, (wrb) a0  <-- 0

## Performance metrics

Performance metrics for section 0 @ (9, 968):
tstart                                          11
snitch_loads                                     7
snitch_stores                                   31
tend                                           970
fpss_loads                                       0
snitch_avg_load_latency                      16.71
snitch_occupancy                            0.3073
...
fpss_occupancy                             0.03333
fpss_fpu_occupancy                         0.03333
