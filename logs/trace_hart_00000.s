...
#;   la        t0, __cdata_end
            496000    0x80000130 auipc t0, 5                    #; (wrb) t0  <-- 0x80005130
            497000    0x80000134 addi t0, t0, -600              #; t0  = 0x80005130, (wrb) t0  <-- 0x80004ed8
#; .Lpcrel_hi1 (start.S:122)
#;   la        t1, __cdata_start
            498000    0x80000138 auipc t1, 5                    #; (wrb) t1  <-- 0x80005138
            499000    0x8000013c addi t1, t1, -608              #; t1  = 0x80005138, (wrb) t1  <-- 0x80004ed8
#; .Lpcrel_hi1 (start.S:123)
#;   sub       t0, t0, t1
            500000    0x80000140 sub t0, t0, t1                 #; t0  = 0x80004ed8, t1  = 0x80004ed8, (wrb) t0  <-- 0
#; .Lpcrel_hi1 (start.S:124)
#;   sub       a2, a2, t0
            501000    0x80000144 sub a2, a2, t0                 #; a2  = 0x10020000, t0  = 0, (wrb) a2  <-- 0x10020000
#; .Lpcrel_hi2 (start.S:125)
#;   la        t0, __cbss_end
            502000    0x80000148 auipc t0, 5                    #; (wrb) t0  <-- 0x80005148
            503000    0x8000014c addi t0, t0, -592              #; t0  = 0x80005148, (wrb) t0  <-- 0x80004ef8
#; .Lpcrel_hi3 (start.S:126)
#;   la        t1, __cbss_start
            504000    0x80000150 auipc t1, 5                    #; (wrb) t1  <-- 0x80005150
            505000    0x80000154 addi t1, t1, -632              #; t1  = 0x80005150, (wrb) t1  <-- 0x80004ed8
#; .Lpcrel_hi3 (start.S:127)
#;   sub       t0, t0, t1
            506000    0x80000158 sub t0, t0, t1                 #; t0  = 0x80004ef8, t1  = 0x80004ed8, (wrb) t0  <-- 32
...
#;   la        t0, __tdata_end
            516000    0x80000180 auipc t0, 5                    #; (wrb) t0  <-- 0x80005180
            517000    0x80000184 addi t0, t0, -748              #; t0  = 0x80005180, (wrb) t0  <-- 0x80004e94
#; .Lpcrel_hi5 (start.S:156)
#;   la        t1, __tdata_start
            518000    0x80000188 auipc t1, 5                    #; (wrb) t1  <-- 0x80005188
            519000    0x8000018c addi t1, t1, -768              #; t1  = 0x80005188, (wrb) t1  <-- 0x80004e88
#; .Lpcrel_hi5 (start.S:157)
#;   sub       t0, t0, t1
            520000    0x80000190 sub t0, t0, t1                 #; t0  = 0x80004e94, t1  = 0x80004e88, (wrb) t0  <-- 12
#; .Lpcrel_hi5 (start.S:158)
#;   sub       sp, sp, t0
            521000    0x80000194 sub sp, sp, t0                 #; sp  = 0x1001ffd8, t0  = 12, (wrb) sp  <-- 0x1001ffcc
#; .Lpcrel_hi6 (start.S:159)
#;   la        t0, __tbss_end
            522000    0x80000198 auipc t0, 5                    #; (wrb) t0  <-- 0x80005198
            523000    0x8000019c addi t0, t0, -704              #; t0  = 0x80005198, (wrb) t0  <-- 0x80004ed8
#; .Lpcrel_hi7 (start.S:160)
#;   la        t1, __tbss_start
            524000    0x800001a0 auipc t1, 5                    #; (wrb) t1  <-- 0x800051a0
            525000    0x800001a4 addi t1, t1, -776              #; t1  = 0x800051a0, (wrb) t1  <-- 0x80004e98
#; .Lpcrel_hi7 (start.S:161)
#;   sub       t0, t0, t1
            526000    0x800001a8 sub t0, t0, t1                 #; t0  = 0x80004ed8, t1  = 0x80004e98, (wrb) t0  <-- 64
...
#;   call snrt_main
            531000    0x800001bc auipc ra, 3                    #; (wrb) ra  <-- 0x800031bc
            532000    0x800001c0 jalr -616(ra)                  #; ra  = 0x800031bc, (wrb) ra  <-- 0x800001c4, goto 0x80002f54
#; snrt_main (start.c:204)
#;   EXTERN_C void snrt_main() {
            543000    0x80002f54 addi sp, sp, -48               #; sp  = 0x1001ff88, (wrb) sp  <-- 0x1001ff58
            544000    0x80002f58 sw ra, 44(sp)                  #; sp  = 0x1001ff58, 0x800001c4 ~~> Word[0x1001ff84]
            545000    0x80002f5c sw s0, 40(sp)                  #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff80]
            546000    0x80002f60 sw s1, 36(sp)                  #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff7c]
            547000    0x80002f64 sw s2, 32(sp)                  #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff78]
            548000    0x80002f68 sw s3, 28(sp)                  #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff74]
            549000    0x80002f6c sw s4, 24(sp)                  #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff70]
            550000    0x80002f70 sw s5, 20(sp)                  #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff6c]
            551000    0x80002f74 sw s6, 16(sp)                  #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff68]
            552000    0x80002f78 sw s7, 12(sp)                  #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff64]
            553000    0x80002f7c sw s8, 8(sp)                   #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff60]
            556000    0x80002f80 sw s9, 4(sp)                   #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff5c]
            557000    0x80002f84 sw s10, 0(sp)                  #; sp  = 0x1001ff58, 0 ~~> Word[0x1001ff58]
...
#;         ^
            559000    0x80002f8c csrr s2, mhartid               #; mhartid = 0, (wrb) s2  <-- 0
...
#;                                   ^
            562000    0x80002f98 mulhu a0, s2, a0               #; s2  = 0, a0  = 0x38e38e39
            564000                                              #; (acc) a0  <-- 0
            565000    0x80002f9c srli a0, a0, 1                 #; a0  = 0, (wrb) a0  <-- 0
            566000    0x80002fa0 li a1, 9                       #; (wrb) a1  <-- 9
            567000    0x80002fa4 slli s6, a0, 18                #; a0  = 0, (wrb) s6  <-- 0
#; snrt_main (start.c:206:9)
#;   if (snrt_cluster_idx() == 0) {
#;       ^
            568000    0x80002fa8 bgeu s2, a1, 136               #; s2  = 0, a1  = 9, not taken
...
#;         return snrt_global_core_idx() % snrt_cluster_core_num();
#;                                       ^
            569000    0x80002fac .text                          #; s2  = 0
            570000    0x80002fb0 li a1, 57                      #; (wrb) a1  <-- 57
            571000                                              #; (acc) a0  <-- 0
            572000    0x80002fb4 mul a0, a0, a1                 #; a0  = 0, a1  = 57
            574000                                              #; (acc) a0  <-- 0
            575000    0x80002fb8 srli a0, a0, 9                 #; a0  = 0, (wrb) a0  <-- 0
            576000    0x80002fbc slli a1, a0, 3                 #; a0  = 0, (wrb) a1  <-- 0
            577000    0x80002fc0 add a0, a1, a0                 #; a1  = 0, a0  = 0, (wrb) a0  <-- 0
            578000    0x80002fc4 sub a1, s2, a0                 #; s2  = 0, a0  = 0, (wrb) a1  <-- 0
...
#;         return snrt_global_core_idx() % snrt_cluster_core_num();
#;                                       ^
            596000    0x80002fe0 .text                          #; a1  = 0
            597000    0x80002fe4 li a5, 1                       #; (wrb) a5  <-- 1
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;     snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:28)
#;       snrt_int_cluster_clr(1 << snrt_cluster_core_idx());
#;                              ^
            598000    0x80002fe8 sll a5, a5, a1                 #; a5  = 1, a1  = 0, (wrb) a5  <-- 1
            599000                                              #; (acc) a0  <-- 0
            621000                                              #; (lsu) a4  <-- 0
#; snrt_main (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:48:5)
...
#;         snrt_cluster()->peripheral_reg.cl_clint_clear.f.cl_clint_clear = mask;
#;                                                                        ^
            622000    0x80002fec and a4, a4, s3                 #; a4  = 0, s3  = -1, (wrb) a4  <-- 0
            623000    0x80002ff0 sw a4, 0(a3)                   #; a3  = 0x100211ac, 0 ~~> Word[0x100211ac]
            624000    0x80002ff4 sw a5, 0(a2)                   #; a2  = 0x100211a8, 1 ~~> Word[0x100211a8]
            625000    0x80002ff8 lui a2, 128                    #; (wrb) a2  <-- 0x00080000
...
#;              ^
            626000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            627000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            628000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            629000    0x80002ffc csrr a3, mip                   #; mip = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            630000    0x80003000 and a3, a3, a2                 #; a3  = 0x00080000, a2  = 0x00080000, (wrb) a3  <-- 0x00080000
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            631000    0x80003004 bnez a3, -8                    #; a3  = 0x00080000, taken, goto 0x80002ffc
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:12)
#;       while (read_csr(mip) & MIP_MCIP)
...
#;       while (read_csr(mip) & MIP_MCIP)
#;              ^
            686000    0x80002ffc csrr a3, mip                   #; mip = 0, (wrb) a3  <-- 0
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;       while (read_csr(mip) & MIP_MCIP)
#;                            ^
            687000    0x80003000 and a3, a3, a2                 #; a3  = 0, a2  = 0x00080000, (wrb) a3  <-- 0
#; .LBB25_2 (start.c:207:9)
#;   snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;     snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;       while (read_csr(mip) & MIP_MCIP)
#;       ^
            688000    0x80003004 bnez a3, -8                    #; a3  = 0, not taken
            689000    0x80003008 li a2, 8                       #; (wrb) a2  <-- 8
#; .LBB25_2 (start.c:206:28)
#;   if (snrt_cluster_idx() == 0) {
#;                          ^
            690000    0x8000300c sltu a2, a2, s2                #; a2  = 8, s2  = 0, (wrb) a2  <-- 0
            691000    0x80003010 .text                          #; a1  = 0
            693000                                              #; (acc) a1  <-- 0
            694000    0x80003014 snez a3, a1                    #; a1  = 0, (wrb) a3  <-- 0
#; .LBB25_2 (start.c:221:5)
#;   snrt_wake_up (start.c:124:33)
#;     if (snrt_cluster_idx() == 0 && snrt_cluster_core_idx() == 0) {
#;                                 ^
            695000    0x80003018 or a2, a2, a3                  #; a2  = 0, a3  = 0, (wrb) a2  <-- 0
            696000    0x8000301c seqz s5, a1                    #; a1  = 0, (wrb) s5  <-- 1
            697000    0x80003020 bnez a2, 32                    #; a2  = 0, not taken
            698000    0x80003024 li a0, 0                       #; (wrb) a0  <-- 0
#; .LBB25_2 (start.c:221:5)
#;   snrt_wake_up (start.c:133:9)
#;     snrt_fence (riscv.h:19:28)
#;       inline void snrt_fence() { asm volatile("fence" : : :); }
#;                                  ^
            699000    0x80003028 fence                          #; 
            700000    0x8000302c j 20                           #; goto 0x80003040
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:137:5)
#;     snrt_cluster_hw_barrier (sync.h:174:5)
#;       asm volatile("csrr x0, 0x7C2" ::: "memory");
#;       ^
            701000    0x80003040 csrr zero, 1986                #; csr@7c2 = 0
...
#;                                                                          ^
            ...
            738000                                              #; (lsu) a1  <-- 0
            739000    0x80003054 ori a1, s4, 4                  #; s4  = 0x100211a8, (wrb) a1  <-- 0x100211ac
            740000    0x80003058 lw a2, 0(a1)                   #; a1  = 0x100211ac, a2  <~~ Word[0x100211ac]
            741000    0x8000305c li a3, 1                       #; (wrb) a3  <-- 1
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:48:5)
#;       snrt_int_clr_mcip_unsafe (cluster_interrupts.h:33:28)
#;         snrt_int_cluster_clr(1 << snrt_cluster_core_idx());
#;                                ^
            742000    0x80003060 sll a3, a3, a0                 #; a3  = 1, a0  = 0, (wrb) a3  <-- 1
            764000                                              #; (lsu) a2  <-- 0
#; .LBB25_6 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:48:5)
...
#;           snrt_cluster()->peripheral_reg.cl_clint_clear.f.cl_clint_clear = mask;
#;                                                                          ^
            765000    0x80003064 and a2, a2, s3                 #; a2  = 0, s3  = -1, (wrb) a2  <-- 0
            766000    0x80003068 sw a3, 0(s4)                   #; s4  = 0x100211a8, 1 ~~> Word[0x100211a8]
            767000    0x8000306c sw a2, 0(a1)                   #; a1  = 0x100211ac, 0 ~~> Word[0x100211ac]
            768000    0x80003070 lui a1, 128                    #; (wrb) a1  <-- 0x00080000
...
#;         while (read_csr(mip) & MIP_MCIP)
#;                ^
            769000    0x80003074 csrr a2, mip                   #; mip = 0, (wrb) a2  <-- 0
#; .LBB25_7 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;       snrt_int_wait_mcip_clr (cluster_interrupts.h:40:26)
#;         while (read_csr(mip) & MIP_MCIP)
#;                              ^
            770000    0x80003078 and a2, a2, a1                 #; a2  = 0, a1  = 0x00080000, (wrb) a2  <-- 0
#; .LBB25_7 (start.c:221:5)
#;   snrt_wake_up (start.c:140:5)
#;     snrt_int_clr_mcip (cluster_interrupts.h:49:5)
#;       snrt_int_wait_mcip_clr (cluster_interrupts.h:40:5)
#;         while (read_csr(mip) & MIP_MCIP)
#;         ^
            771000    0x8000307c bnez a2, -8                    #; a2  = 0, not taken
...
#;         ^
            786000    0x800030a8 beqz s5, 120                   #; s5  = 1, not taken
#; .LBB25_33 (start.c:239:5)
#;   snrt_init_cls (start.c:172:17)
#;     if (size)
#;         ^
            787000    0x800030ac sub s1, s8, s0                 #; s8  = 0x80004ed8, s0  = 0x80004ed8, (wrb) s1  <-- 0
            788000    0x800030b0 beqz s1, 36                    #; s1  = 0, taken, goto 0x800030d4
#; .LBB25_11 (start.c:239:5)
#;   snrt_init_cls (start.c:177:21)
#;     if (size)
#;         ^
            789000    0x800030d4 sub a2, s9, s10                #; s9  = 0x80004ef8, s10 = 0x80004ed8, (wrb) a2  <-- 32
            790000    0x800030d8 beqz a2, 36                    #; a2  = 32, not taken
#; .LBB25_11 (start.c:239:5)
#;   snrt_init_cls (start.c:178:20)
#;     memset((void*)ptr, 0, size);
#;     ^
            791000    0x800030dc add a0, s1, a2                 #; s1  = 0, a2  = 32, (wrb) a0  <-- 32
            792000    0x800030e0 add a0, a0, s0                 #; a0  = 32, s0  = 0x80004ed8, (wrb) a0  <-- 0x80004ef8
            793000    0x800030e4 sub a0, s8, a0                 #; s8  = 0x80004ed8, a0  = 0x80004ef8, (wrb) a0  <-- -32
            794000    0x800030e8 lui a1, 65568                  #; (wrb) a1  <-- 0x10020000
            795000    0x800030ec add a0, a0, a1                 #; a0  = -32, a1  = 0x10020000, (wrb) a0  <-- 0x1001ffe0
            796000    0x800030f0 li a1, 0                       #; (wrb) a1  <-- 0
            797000    0x800030f4 auipc ra, 0                    #; (wrb) ra  <-- 0x800030f4
            798000    0x800030f8 jalr 624(ra)                   #; ra  = 0x800030f4, (wrb) ra  <-- 0x800030fc, goto 0x80003364
#; memset (memset.S:30)
#;   li t1, 15
            812000    0x80003364 li t1, 15                      #; (wrb) t1  <-- 15
#; memset (memset.S:31)
#;   move a4, a0
            813000    0x80003368 mv a4, a0                      #; a0  = 0x1001ffe0, (wrb) a4  <-- 0x1001ffe0
#; memset (memset.S:32)
#;   bleu a2, t1, .Ltiny
            814000    0x8000336c bgeu t1, a2, 60                #; t1  = 15, a2  = 32, not taken
#; memset (memset.S:33)
#;   and a5, a4, 15
            815000    0x80003370 andi a5, a4, 15                #; a4  = 0x1001ffe0, (wrb) a5  <-- 0
#; memset (memset.S:34)
#;   bnez a5, .Lmisaligned
            816000    0x80003374 bnez a5, 160                   #; a5  = 0, not taken
#; .Laligned (memset.S:37)
#;   bnez a1, .Lwordify
            817000    0x80003378 bnez a1, 132                   #; a1  = 0, not taken
#; .Lwordified (memset.S:40)
#;   and a3, a2, ~15
            818000    0x8000337c andi a3, a2, -16               #; a2  = 32, (wrb) a3  <-- 32
#; .Lwordified (memset.S:41)
#;   and a2, a2, 15
            826000    0x80003380 andi a2, a2, 15                #; a2  = 32, (wrb) a2  <-- 0
#; .Lwordified (memset.S:42)
#;   add a3, a3, a4
            827000    0x80003384 add a3, a3, a4                 #; a3  = 32, a4  = 0x1001ffe0, (wrb) a3  <-- 0x10020000
#; .Ltmp0 (memset.S:48)
#;   1:sw a1, 0(a4)
            828000    0x80003388 sw a1, 0(a4)                   #; a4  = 0x1001ffe0, 0 ~~> Word[0x1001ffe0]
#; .Ltmp0 (memset.S:49)
#;   sw a1, 4(a4)
            829000    0x8000338c sw a1, 4(a4)                   #; a4  = 0x1001ffe0, 0 ~~> Word[0x1001ffe4]
#; .Ltmp0 (memset.S:50)
#;   sw a1, 8(a4)
            830000    0x80003390 sw a1, 8(a4)                   #; a4  = 0x1001ffe0, 0 ~~> Word[0x1001ffe8]
#; .Ltmp0 (memset.S:51)
#;   sw a1, 12(a4)
            831000    0x80003394 sw a1, 12(a4)                  #; a4  = 0x1001ffe0, 0 ~~> Word[0x1001ffec]
#; .Ltmp0 (memset.S:53)
#;   add a4, a4, 16
            832000    0x80003398 addi a4, a4, 16                #; a4  = 0x1001ffe0, (wrb) a4  <-- 0x1001fff0
#; .Ltmp0 (memset.S:54)
#;   bltu a4, a3, 1b
            833000    0x8000339c bltu a4, a3, -20               #; a4  = 0x1001fff0, a3  = 0x10020000, taken, goto 0x80003388
#; .Ltmp0 (memset.S:48)
#;   1:sw a1, 0(a4)
            834000    0x80003388 sw a1, 0(a4)                   #; a4  = 0x1001fff0, 0 ~~> Word[0x1001fff0]
#; .Ltmp0 (memset.S:49)
#;   sw a1, 4(a4)
            835000    0x8000338c sw a1, 4(a4)                   #; a4  = 0x1001fff0, 0 ~~> Word[0x1001fff4]
#; .Ltmp0 (memset.S:50)
#;   sw a1, 8(a4)
            836000    0x80003390 sw a1, 8(a4)                   #; a4  = 0x1001fff0, 0 ~~> Word[0x1001fff8]
#; .Ltmp0 (memset.S:51)
#;   sw a1, 12(a4)
            837000    0x80003394 sw a1, 12(a4)                  #; a4  = 0x1001fff0, 0 ~~> Word[0x1001fffc]
#; .Ltmp0 (memset.S:53)
#;   add a4, a4, 16
            838000    0x80003398 addi a4, a4, 16                #; a4  = 0x1001fff0, (wrb) a4  <-- 0x10020000
#; .Ltmp0 (memset.S:54)
#;   bltu a4, a3, 1b
            839000    0x8000339c bltu a4, a3, -20               #; a4  = 0x10020000, a3  = 0x10020000, not taken
#; .Ltmp0 (memset.S:56)
#;   bnez a2, .Ltiny
            840000    0x800033a0 bnez a2, 8                     #; a2  = 0, not taken
#; .Ltmp0 (memset.S:57)
#;   ret
            841000    0x800033a4 ret                            #; ra  = 0x800030fc, goto 0x800030fc
#; .LBB25_13 (start.c:239:5)
#;   snrt_init_cls (start.c:182:14)
#;     _cls_ptr = (cls_t*)snrt_cls_base_addr();
#;              ^
            842000    0x800030fc add a0, s1, s9                 #; s1  = 0, s9  = 0x80004ef8, (wrb) a0  <-- 0x80004ef8
            843000    0x80003100 sub a0, s10, a0                #; s10 = 0x80004ed8, a0  = 0x80004ef8, (wrb) a0  <-- -32
            844000    0x80003104 lui a1, 65568                  #; (wrb) a1  <-- 0x10020000
            845000    0x80003108 add a0, a0, a1                 #; a0  = -32, a1  = 0x10020000, (wrb) a0  <-- 0x1001ffe0
            846000    0x8000310c lui a1, 0                      #; (wrb) a1  <-- 0
            847000    0x80003110 add a1, a1, tp                 #; a1  = 0, tp  = 0x1001ff88, (wrb) a1  <-- 0x1001ff88
            848000    0x80003114 sw a0, 64(a1)                  #; a1  = 0x1001ff88, 0x1001ffe0 ~~> Word[0x1001ffc8]
#; .LBB25_13 (start.c:239:5)
#;   snrt_init_cls (start.c:183:5)
#;     snrt_cluster_hw_barrier (sync.h:174:5)
#;       asm volatile("csrr x0, 0x7C2" ::: "memory");
#;       ^
            849000    0x80003118 csrr zero, 1986                #; csr@7c2 = 0
            851000    0x8000311c j 128                          #; goto 0x8000319c
...
#;         asm volatile("csrr x0, 0x7C2" ::: "memory");
#;         ^
            854000    0x8000319c csrr zero, 1986                #; csr@7c2 = 0
...
#;                                    ^
            ...
            887000    0x800031ac add a1, a1, tp                 #; a1  = 0, tp  = 0x1001ff88, (wrb) a1  <-- 0x1001ff88
            888000    0x800031b0 sw zero, 20(a1)                #; a1  = 0x1001ff88, 0 ~~> Word[0x1001ff9c]
            889000    0x800031b4 sw a0, 16(a1)                  #; a1  = 0x1001ff88, 0x10000000 ~~> Word[0x1001ff98]
            890000    0x800031b8 addi a1, a1, 16                #; a1  = 0x1001ff88, (wrb) a1  <-- 0x1001ff98
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:190:5)
#;     snrt_l1_init (alloc_v2.h:119:33)
#;       snrt_l1_allocator_v2()->end = heap_end_addr;
#;                                   ^
            891000    0x800031bc sw zero, 12(a1)                #; a1  = 0x1001ff98, 0 ~~> Word[0x1001ffa4]
            ...
            898000    0x800031d8 sw a2, 8(a1)                   #; a1  = 0x1001ff98, 0x1001db60 ~~> Word[0x1001ffa0]
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:190:5)
#;     snrt_l1_init (alloc_v2.h:120:34)
#;       snrt_l1_allocator_v2()->next = snrt_l1_allocator_v2()->base;
#;                                    ^
            899000    0x800031dc sw zero, 20(a1)                #; a1  = 0x1001ff98, 0 ~~> Word[0x1001ffac]
            900000    0x800031e0 sw a0, 16(a1)                  #; a1  = 0x1001ff98, 0x10000000 ~~> Word[0x1001ffa8]
#; .LBB25_16 (start.c:247:5)
...
#;                                    ^
            ...
            902000    0x800031e8 add a0, a0, tp                 #; a0  = 0, tp  = 0x1001ff88, (wrb) a0  <-- 0x1001ff88
            903000    0x800031ec sw zero, 44(a0)                #; a0  = 0x1001ff88, 0 ~~> Word[0x1001ffb4]
            ...
            906000    0x800031f8 sw a1, 40(a0)                  #; a0  = 0x1001ff88, 0x80007668 ~~> Word[0x1001ffb0]
            907000    0x800031fc addi a0, a0, 40                #; a0  = 0x1001ff88, (wrb) a0  <-- 0x1001ffb0
...
#;                                   ^
            909000    0x80003204 sw a2, 12(a0)                  #; a0  = 0x1001ffb0, 1 ~~> Word[0x1001ffbc]
            910000    0x80003208 sw zero, 8(a0)                 #; a0  = 0x1001ffb0, 0 ~~> Word[0x1001ffb8]
#; .LBB25_16 (start.c:247:5)
#;   snrt_init_libs (start.c:191:5)
#;     snrt_l3_init (alloc_v2.h:187:34)
#;       snrt_l3_allocator_v2()->next = snrt_l3_allocator_v2()->base;
#;                                    ^
            911000    0x8000320c sw zero, 20(a0)                #; a0  = 0x1001ffb0, 0 ~~> Word[0x1001ffc4]
            912000    0x80003210 sw a1, 16(a0)                  #; a0  = 0x1001ffb0, 0x80007668 ~~> Word[0x1001ffc0]
#; .LBB25_16 (start.c:247:5)
...
#;                                                      ^
            ...
            914000    0x80003218 add s0, a0, tp                 #; a0  = 0, tp  = 0x1001ff88, (wrb) s0  <-- 0x1001ff88
            915000    0x8000321c lui a0, 0                      #; (wrb) a0  <-- 0
            916000    0x80003220 add a0, a0, tp                 #; a0  = 0, tp  = 0x1001ff88, (wrb) a0  <-- 0x1001ff88
            917000    0x80003224 mv a0, a0                      #; a0  = 0x1001ff88, (wrb) a0  <-- 0x1001ff88
            918000    0x80003228 sw a0, 76(s0)                  #; s0  = 0x1001ff88, 0x1001ff88 ~~> Word[0x1001ffd4]
...
#;       asm("csrr %0, mhartid" : "=r"(hartid));
#;       ^
            944000    0x800001d0 csrr a0, mhartid               #; mhartid = 0, (wrb) a0  <-- 0
            945000    0x800001d4 li a1, 2                       #; (wrb) a1  <-- 2
#; main (xpulp_abs.c:8:8)
#;   if (i == 2) {
#;       ^
            946000    0x800001d8 bne a0, a1, 24                 #; a0  = 0, a1  = 2, taken, goto 0x800001f0
...
#;                                        ^
            ...
            957000    0x80003240 add a1, a1, tp                 #; a1  = 0, tp  = 0x1001ff88, (wrb) a1  <-- 0x1001ff88
            958000    0x80003244 lw a1, 64(a1)                  #; a1  = 0x1001ff88, a1  <~~ Word[0x1001ffc8]
...
#;           ^
            967000    0x80003250 mv a0, a0                      #; a0  = 0, (wrb) a0  <-- 0
#; .LBB25_16 (start.c:280:5)
#;   snrt_exit (start.h:20:40)
#;     snrt_exit_default (start.h:11:17)
...
#;           asm volatile("csrr x0, 0x7C2" ::: "memory");
#;           ^
            968000    0x80003254 csrr zero, 1986                #; csr@7c2 = 0
#; .LBB25_16 (start.c:280:5)
#;   snrt_exit (start.h:20:40)
#;     snrt_exit_default (start.h:11:17)
...
#;         if (snrt_cluster_core_idx() == 0) {
#;             ^
            994000    0x80003258 beqz s5, 84                    #; s5  = 1, not taken
#; .LBB25_16 (start.c:280:5)
#;   snrt_exit (start.h:20:40)
#;     snrt_exit_default (start.h:11:17)
...
#;                                                ^
            995000    0x8000325c lw a2, 4(a1)                   #; a1  = 0x1001ffe0, a2  <~~ Word[0x1001ffe4]
#; .LBB25_35 (start.c:280:5)
#;   snrt_exit (start.h:20:40)
#;     snrt_exit_default (start.h:11:17)
#;       snrt_global_all_to_all_reduction (sync.h:301:9)
#;         __atomic_add_fetch(&_reduction_result, *cluster_result,
#;         ^
            996000    0x80003260 auipc a0, 2                    #; (wrb) a0  <-- 0x80005260
            997000    0x80003264 addi a0, a0, -684              #; a0  = 0x80005260, (wrb) a0  <-- 0x80004fb4
            998000                                              #; (lsu) a2  <-- 0
            999000    0x80003268 amoadd.w a2, a2, (a0)          #; a0  = 0x80004fb4, a2  = 0, a2  <~~ Word[0x80004fb4]
#; .LBB25_35 (start.c:280:5)
#;   snrt_exit (start.h:20:40)
#;     snrt_exit_default (start.h:11:17)
...
#;             asm volatile("csrr x0, 0x7C2" ::: "memory");
#;             ^
           1000000    0x8000326c csrr zero, 1986                #; csr@7c2 = 0
           1015000                                              #; (lsu) a2  <-- 0
           1016000    0x80003270 lw a2, 76(s0)                  #; s0  = 0x1001ff88, a2  <~~ Word[0x1001ffd4]
           1019000                                              #; (lsu) a2  <-- 0x1001ff88

## Performance metrics

Performance metrics for section 0 @ (8, 1017):
tstart                                          10
snitch_loads                                    10
snitch_stores                                   39
tend                                          1019
fpss_loads                                       0
snitch_avg_load_latency                       12.3
snitch_occupancy                            0.3386
snitch_fseq_rel_offloads                   0.08556
fseq_yield                                     1.0
fseq_fpu_yield                                 1.0
fpss_section_latency                             0
fpss_avg_fpu_latency                           2.0
fpss_avg_load_latency                            0
fpss_occupancy                             0.03168
fpss_fpu_occupancy                         0.03168
